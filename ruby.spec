...
Patch29: ruby-2.3.0-test_gem_remote_fetcher.rb-get-rid-of-errors.patch
...
# Relax the memory leak limit. It used to be 2.0, so 1.6 should be OK to pass
# on RHEL6.
sed -i "/assert_no_memory_leak/ s/limit: 1.5/limit: 1.6/" test/ruby/envutil.rb
