...
Patch18: ruby-2.1.1-fix-test-failures-due-to-expired-certs.patch
# Fix tk extconf not to include -rpath
# - p19 is upstream revision
# - p20 is my fix for the revision (otherwise tcl/tk won't build)
# https://bugs.ruby-lang.org/issues/9386
Patch19: ruby-trunk-tk-rpath-fix.patch
Patch20: ruby-trunk-tk-extconf-fix.patch
