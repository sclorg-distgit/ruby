...
%global release 6
%{!?release_string:%global release_string %{?development_release:0.}%{release}%{?development_release:.%{development_release}}.bs1%{?dist}}
...
Patch11: ruby-2.6.0-Fix-Tokyo-TZ-tests.patch
